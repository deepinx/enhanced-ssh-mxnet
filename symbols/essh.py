...
def get_symbol():
    ...
    for stride in config.RPN_FEAT_STRIDE:
      ...
      if config.TRAIN.RPN_ENABLE_OHEM<0:
        rpn_bbox_kpoint_list.append(rpn_kpoint_pred_reshape)
        ...
        kpoint_weight = mx.sym.slice_axis(bbox_weight, axis=1, begin=0, end=1)
        kpoint_diff = mx.sym.broadcast_mul(kpoint_diff, kpoint_weight)
        rpn_kpoint_loss_ = mx.symbol.smooth_l1(name='rpn_kpoint_loss_stride%d_'%stride, scalar=3.0, data=kpoint_diff)
