...
class ProposalFPNOutOperator(mx.operator.CustomOp):
    def __init__(self, feat_stride_fpn, scales, ratios, output_score,
      rpn_pre_nms_top_n, rpn_post_nms_top_n, threshold, rpn_min_size_fpn):
        super(ProposalFPNOutOperator, self).__init__()
...
@mx.operator.register("proposal_fpn_out")
class ProposalFPNOutProp(mx.operator.CustomOpProp):
    def __init__(self, feat_stride='(64,32,16,8,4)', scales='(8)', ratios='(0.5, 1, 2)', output_score='False',
      rpn_pre_nms_top_n='6000', rpn_post_nms_top_n='300', threshold='0.3', rpn_min_size='(64,32,16,8,4)'):
        super(ProposalFPNOutProp, self).__init__(need_top_grad=False)
    ...
    def create_operator(self, ctx, shapes, dtypes):
      return ProposalFPNOutOperator(self._feat_stride_fpn, self._scales, self._ratios, self._output_score,
